        ...
        return a(this).each(function(b, d) {
            ...
            function() {
                ...
                return d && "" != d ? (e.attr(c.data, d).attr("title", "").removeAttr("title"), b = a('<div id="smohan-title-tip"></div>'), b.css("opacity", 0).html(d).appendTo("body"), f = function() {
                    ...
                    0 > c ? (c = e.offset().left + e.outerWidth() / 2 - 20, b.addClass("left")) : b.removeClass("left"),
                    c + b.outerWidth() > a(window).width() ? (c = e.offset().left - b.outerWidth() + e.outerWidth() / 2 + 20, b.addClass("right")) : b.removeClass("right"),
                    0 > d ? (d = e.offset().top + e.outerHeight(), b.addClass("top")) : b.removeClass("top"),
                    b.css({
                        left: c,
                        top: d
                    }).animate({
...
var os = function() {
    ...
    b.weChat = b.android = b.ios = b.iPad = b.iPhone = b.wp = b.mobile = !1,
    b.webkit = h ? !0 : !1,
    i && (b.mobile = !0),
    c && (b.weChat = !0, b.version = c[1]),
    d && (b.android = b.mobile = !0, b.version = d[2]),
    g && (b.wp = b.mobile = !0, b.version = g[2]),
    (e || f) && (b.ios = b.mobile = !0, e && (b.iPad = !0, b.version = e[2]), f && (b.iPhone = !0, b.version = f[2]), b.version = b.version.replace(/_/g, "."), b.ios && b.version && 0 <= a.indexOf("Version/") && "10" === b.version.split(".")[0] && (b.version = a.toLowerCase().split("version/")[1].split(" ")[0])),
    b
} (); !
function(a) {
    function b() {
        var b = (new Date).getTime() - new Date(2009, 12, 30, 16, 2, 2).getTime(),
        c = b % 31104000000,
        d = c % 2592000000,
        e = d % 86400000,
        f = e % 3600000;
        i = [Math.floor(b / 31104000000), Math.floor(c / 2592000000), Math.floor(d / 86400000), Math.floor(e / 3600000), Math.floor(f / 60000), Math.floor(f % 60000 / 1000)],
        h.each(function(b, c) {
            a(c).css({
    ...
    function e() {
        ...
        return "N" != e ? ((s = document.createElement("audio"), s.src = c, s ? (s.play(), s.loop = !0) : s.load(), d() ? t.removeClass("play").addClass("play-safari") : t.removeClass("play-safari").addClass("play")), void 0) : (b.style.display = "none", !1)
    }
    function f() {
    ...
    function g() {
        ...
        function(a) {
            a = a || window.event;
            var b = parseInt(a.keyCode); ! a.ctrlKey || 115 !== b && 83 !== b ? (123 === b || a.ctrlKey && a.shiftKey && 73 === b || a.ctrlKey && 85 === b) && (a.returnValue = !1, a.preventDefault(), p()) : (a.returnValue = !1, a.preventDefault(), p())
        }),
        ...
        function() {
            document.title = document.hidden ? "看这里，看这里!": "Geek"
        })
    }
    ...
    a("#next-page-for-init").bind("click",
    function() {
        r.moveTo(1)
    }),
    a(".u-menu-btn").on("click",
    function() {
        a(this).toggleClass("close"),
        a("#navgation,.nav-mask").toggleClass("active")
    }),
    os.mobile || a('[rel="title-tip"]').titleTip(),
    s = null,
    t = a("#smohan-v4-music"),
    u = d() ? "play-safari": "play",
    t.on("click",
    function() {
